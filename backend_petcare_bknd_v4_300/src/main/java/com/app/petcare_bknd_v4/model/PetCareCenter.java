package com.app.petcare_bknd_v4.model;
...
import com.app.petcare_bknd_v4.converter.DurationConverter;
import com.app.petcare_bknd_v4.converter.UUIDToByteConverter;
import com.app.petcare_bknd_v4.converter.UUIDToStringConverter;
...
@Table(name = "\"PetCareCenter\"", schema =  "\"petcare_bknd_v4_625\"")
@Data
...
@Column(name = "\"BusinessHours\"")
    ...
    @CollectionTable(schema = "\"petcare_bknd_v4_625\"", name = "\"PetCareCenterBusinessHours\"",joinColumns = @JoinColumn(name = "\"PcId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"DocId\""), schema = "\"petcare_bknd_v4_625\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"ServiceId\""), schema = "\"petcare_bknd_v4_625\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"PetId\""), schema = "\"petcare_bknd_v4_625\"")
